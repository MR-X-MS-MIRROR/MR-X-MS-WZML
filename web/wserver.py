    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/MS_NEWONN">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/MR-X-MS-MIRROR/MR-X-MS-WZML"><i class="fab fa-github"></i></a>
        <a href="https://t.me/MS_NEWONN"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/MR-X-MS-MIRROR/MR-X-MS-WZML'>@GitHub</a> By <a href='https://github.com/MR-X-MS-MIRROR'>Code With Weeb</a></h1>"
